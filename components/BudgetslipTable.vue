          ...
          <v-card-text>
            ...
            >
              ...
              <template v-slot:item.budgetplanDes="{ item }">
                <div class="py-2">
                  <div class="body-2">
                    {{ item.budgettypeName }} : {{ item.budgetName }}
                  </div>
          ...
          <v-row>
            <v-col class="col-11 col-md-10 mx-auto my-5">
              <v-card>
                ...
                <BudgetslipInsertVue
                  :budgetslip="budgetslipData"
                  @getInsertStatus="insertBudgetslip"
                />
              </v-card>
            </v-col>
          </v-row>
          ...
          <v-row>
            <v-col class="col-11 col-md-10 mx-auto my-5">
              <v-card>
                ...
                <BudgetslipUpdateVue
                  :budgetslip="budgetslipData"
                  @getUpdateStatus="updateBudgetslip"
                />
              </v-card>
            </v-col>
          </v-row>
          ...
          <v-row>
            <v-col class="col-11 col-md-10 mx-auto my-5">
              <v-card>
                ...
                <BudgetslipDeleteVue
                  :budgetslip="budgetslipData"
                  @getDeleteStatus="deleteBudgetslip"
                />
              </v-card>
            </v-col>
          </v-row>
