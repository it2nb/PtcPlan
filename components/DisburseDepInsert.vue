    ...
    >
      <v-card-text>
        <v-row dense>
          ...
          <v-col cols="12" md="4">
            <v-text-field
              v-model="insertData.disburseAuditHead"
              label="ประธานกรรมการตรวจรับ"
              outlined
              dense
            />
            <v-text-field
              v-model="insertData.disburseAuditHeadPos"
              label="ตำแหน่ง"
              outlined
              dense
            />
          ...
          <v-col cols="12" md="4">
            <v-text-field
              v-model="insertData.disburseAuditComm"
              label="กรรมการตรวจรับ"
              outlined
              dense
            />
            <v-text-field
              v-model="insertData.disburseAuditCommPos"
              label="ตำแหน่ง"
              outlined
              dense
            />
          ...
          <v-col cols="12" md="4">
            <v-text-field
              v-model="insertData.disburseAuditSecr"
              label="กรรมการและเลขานุการตรวจรับ"
              outlined
              dense
            />
            <v-text-field
              v-model="insertData.disburseAuditSecrPos"
              label="ตำแหน่ง"
              outlined
              dense
            />
  ...
  methods: {
    ...
    async insertDisburse() {
      ...
      if(this.insertValidate) {
        ...
        if(new Date(this.insertData.disburseDate).getDay()!=0&&new Date(this.insertData.disburseDate).getDay()!=6) {
