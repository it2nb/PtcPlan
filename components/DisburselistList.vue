...
export default {
  ...
  methods: {
    ...
    showUpdateDialog(disbureslist) {
      this.updateData = JSON.parse(JSON.stringify(disbureslist))
    ...
    showDeleteDialog(disbureslist) {
      this.deleteData = JSON.parse(JSON.stringify(disbureslist))
