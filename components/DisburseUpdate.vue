<template>
  <v-card>
    <v-card-title class="amber lighten-2">
      <span class="fontBold"
        >แก้ไขข้อมูลจัดซื้อ/เบิกเงิน ปีงบประมาณ พ.ศ.{{
        ...
        <v-row dense>
          ...
          <v-col cols="12" md="6">
            ...
            <v-text-field
              ...
              outlined
              required
              :rules="[() => !!updateData.disburseReqName || 'กรุณากรอกข้อมูล']"
            ></v-text-field>
          </v-col>
          <v-col cols="12" md="2">
            ...
            <v-text-field
              ...
              :rules="[() => !!updateData.disburseDate || 'กรุณากรอกข้อมูล']"
            ></v-text-field>
          </v-col>
          <v-col cols="4" md="1">
          ...
          <v-col cols="12" md="4">
            ...
            <v-radio-group
              ...
              row
              :rules="[() => !!updateData.disburseSubtype || 'กรุณากรอกข้อมูล']"
            >
              <v-radio label="ขอซื้อ" value="ซื้อ"></v-radio>
              <v-radio label="ขอจ้าง" value="จ้าง"></v-radio>
              <v-radio label="ขอเช่า" value="เช่า"></v-radio>
              <v-radio label="ขอเบิกจ่ายอื่นๆ" value="เบิกจ่าย"></v-radio>
            </v-radio-group>
          </v-col>
          <v-col cols="12" md="3">
            ...
            <v-radio-group
              ...
              row
              :rules="[() => !!updateData.disburseType || 'กรุณากรอกข้อมูล']"
            >
              <v-radio label="โครงการ" value="โครงการ"></v-radio>
              <v-radio label="ค่าใช้จ่าย" value="ค่าใช้จ่าย"></v-radio>
            </v-radio-group>
          </v-col>
          <v-col cols="12" md="6" v-if="updateData.disburseType == 'โครงการ'">
            ...
            <v-autocomplete
              ...
              outlined
              required
              :rules="[() => !!updateData.projectID || 'กรุณากรอกข้อมูล']"
          ...
          <v-col cols="12" md="6" v-if="updateData.disburseType == 'โครงการ'">
            ...
            <v-autocomplete
              ...
              outlined
              required
              :rules="[() => !!updateData.pjbudgetID || 'กรุณากรอกข้อมูล']"
            >
              <template v-slot:item="{ item }">
                <div class="py-2">
                  ...
                  <div class="pl-2">
                    ...
                    <span
                      class="success--text text--darken-2"
                      v-if="
                        parseFloat(item.bpbudgetrealMoney) -
                          parseFloat(item.bpdisburseMoney) >
                        0
                      "
                      >{{
                        moneyFormat(
          ...
          <v-col
            cols="12"
            md="6"
            v-if="updateData.disburseType == 'ค่าใช้จ่าย'"
          >
            ...
            <v-autocomplete
              ...
              outlined
              required
              :rules="[() => !!updateData.expenseplanID || 'กรุณากรอกข้อมูล']"
          ...
          >
            ...
            <v-autocomplete
              ...
              outlined
              required
              :rules="[() => !!updateData.budgetplanID || 'กรุณากรอกข้อมูล']"
            >
              <template v-slot:item="{ item }">
                <div class="py-2 col-12">
                  ...
                  <div>
                    ...
                    <span
                      class="success--text text--darken-2"
                      v-if="
                        parseFloat(item.budgetslipMoney) -
                          parseFloat(item.bpdisburseMoney) >
                        0
                      "
                      >{{
          ...
          <v-col
            ...
            md="8"
            v-if="
              updateData.disburseType == 'โครงการ' ||
              updateData.disburseType == 'ค่าใช้จ่าย'
            "
          >
            ...
            <v-text-field
              ...
              outlined
              required
              :rules="[() => !!updateData.disburseDes || 'กรุณากรอกข้อมูล']"
            ></v-text-field>
          </v-col>
          <v-col
            cols="12"
          ...
          >
            ...
            <v-text-field
              ...
              outlined
              required
              :rules="[() => !!updateData.disburseMoney || 'กรุณากรอกข้อมูล']"
            ></v-text-field>
          </v-col>
          <v-col
            cols="12"
          ...
          >
            <h3 class="mb-2 fontBold">
              ...
              <span class="text-caption"
                >(ควรเว้นระยะเวลาให้เจ้าหน้าที่ดำเนินการตามกระบวนการทางพัสดุได้ทัน)</span
              >
            </h3>
            <v-text-field
              ...
              :rules="[() => !!updateData.disburseStart || 'กรุณากรอกข้อมูล']"
            ></v-text-field>
          </v-col>
          <v-col
            cols="12"
          ...
          >
            ...
            <v-text-field
              ...
              :rules="[() => !!updateData.disburseEnd || 'กรุณากรอกข้อมูล']"
            ></v-text-field>
          </v-col>
          <v-col
            cols="12"
          ...
          >
            ...
            <v-textarea
              ...
              outlined
              required
              :rules="[() => !!updateData.disburseProduct || 'กรุณากรอกข้อมูล']"
            ></v-textarea>
          </v-col>
          <v-col
            cols="12"
  ...
  methods: {
    ...
    async updateDisburse() {
      ...
      if (this.updateValidate) {
        ...
        if (
          this.pjbudgets.length > 0 &&
          this.updateData.disburseType == "โครงการ"
        ) {
          let pjbudget = await this.pjbudgets.find(
            (pjbudget) => pjbudget.pjbudgetID == this.updateData.pjbudgetID
          );
          if (pjbudget) {
