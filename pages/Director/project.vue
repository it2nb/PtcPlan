<template>
  <div>
    ...
    <div v-if="userID && partyID && projectYear" class="mt-2">
      <ProjectTableVue :userID="userID" :partyID="partyID" :projectYear="projectYear" :insertBt="insertBt" :updateBt="updateBt" :deleteBt="deleteBt" userType="Director" />
    </div>
  </div>
</template>
