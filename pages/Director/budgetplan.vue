    ...
    >
      <v-tab-item>
        <div v-if="personalIDcard && budgetplanYear">
          <BudgetplanTable :personalIDcard="personalIDcard" :budgetplanYear="budgetplanYear" :insertBt="insertBt" :updateBt="updateBt" :deleteBt="deleteBt" userType="Director" />
        </div>
      </v-tab-item>
      <v-tab-item>
        <div v-if="personalIDcard && budgetplanYear">
          <ExpenseplanTable :personalIDcard="personalIDcard" :expenseplanYear="budgetplanYear" :insertBt="insertBt" :updateBt="updateBt" :deleteBt="deleteBt" userType="Director" />
        </div>
      </v-tab-item>
      <v-tab-item>
        <div v-if="personalIDcard && budgetplanYear">
          <BudgetslipTableVue :budgetslipYear="budgetplanYear" />
        </div>
      </v-tab-item>
    </v-tabs-items>
  </div>
