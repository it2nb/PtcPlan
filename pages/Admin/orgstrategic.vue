<template>
  <div>
    ...
    <div v-if="personalIDcard && orgstrategicYear" class="mt-2">
        <OrgstrategicTable :personalIDcard="personalIDcard" :orgstrategicYear="orgstrategicYear" :insertBt="insertBt" :updateBt="updateBt" :deleteBt="deleteBt" userType="Admin" />
    </div>
  </div>
</template>
