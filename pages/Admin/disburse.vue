<template>
  <div>
    ...
    <div v-if="personalIDcard && disburseYear" class="mt-2">
        <DisburseTableVue :personalIDcard="personalIDcard" :userID="userID" :disburseYear="disburseYear" :insertBt="insertBt" :updateBt="updateBt" :deleteBt="deleteBt" userType="Admin" />
    </div>
  </div>
</template>
