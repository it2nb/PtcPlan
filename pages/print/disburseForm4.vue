  ...
  <div style="line-height: 1.8">
    <div class="printPage3x2" v-if="disburse">
      <v-row no-gutters class="mb-2">
        ...
        <v-col cols="12" class="text-center font16 font-weight-bold">
          เรื่อง แต่งตั้ง คณะกรรมการตรวจรับพัสดุ สำหรับจัด{{
          ...
          >
          จำนวน {{ disburselists.length }} รายการ <br />โดยวิธีเฉพาะเจาะจง
        </v-col>
        <v-col cols="12" class="pt-3 font16 thaiJustifiedText" lang="th">
          &emsp;&emsp;&emsp;ด้วยวิทยาลัยเทคนิคแพร่ มีความประสงค์จะ{{
            disburse.disburseSubtype
          ...
          พ.ศ. 2560 จึงขอแต่งตั้งรายชื่อต่อไปนี้เป็น
          คณะกรรมการตรวจรับพัสดุสำหรับ{{ disburse.disburseSubtype
          }}<span class="font16" v-if="disburse.disburseSubtype == 'ซื้อ'">{{
            disburse.disburseType == "โครงการ"
              ? disburse.expenseName.replace("ค่า", "")
              : disburse.expenseplanDes.replace("ค่า", "")
        ...
        <v-col cols="12" class="pt-1 font16">
          <table width="100%" class="font16">
            <tr>
              <td valign="top" class="font16">
                &emsp;&emsp;&emsp;1.
                {{ disburse.disburseAuditHead }}<br />
                &emsp;&emsp;&emsp;&emsp;{{ disburse.disburseAuditHeadPos }}
              </td>
              <td valign="top" class="font16">
                &emsp;&emsp;&emsp;&emsp;ประธานกรรมการฯ
              </td>
            </tr>
            <tr>
              <td valign="top" class="font16">
                &emsp;&emsp;&emsp;2.
                {{ disburse.disburseAuditComm }}<br />
                &emsp;&emsp;&emsp;&emsp;{{ disburse.disburseAuditCommPos }}
              </td>
              <td valign="top" class="font16">
                &emsp;&emsp;&emsp;&emsp;กรรมการ
              </td>
            </tr>
            <tr>
              <td valign="top" class="font16">
                &emsp;&emsp;&emsp;3.
                {{ disburse.disburseAuditSecr }}<br />
                &emsp;&emsp;&emsp;&emsp;{{ disburse.disburseAuditSecrPos }}
              </td>
              <td valign="top" class="font16">
                &emsp;&emsp;&emsp;&emsp;กรรมการและเลขานุการ
              </td>
            </tr>
          </table>
        </v-col>
        <v-col cols="12" class="pt-2 font16">
          &emsp;&emsp;&emsp;อำนาจและหน้าที่<br />
          &emsp;&emsp;&emsp;ทำการตรวจรับพัสดุให้เป็นไปตามเงื่อนไขของสัญญาหรือข้อตกลงนั้น
        </v-col>
