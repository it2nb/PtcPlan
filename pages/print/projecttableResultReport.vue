      ...
      <table width="100%" style="border: solid 1px black; border-spacing: 0;" v-for="orgstrategic in orgstrategics" :key="orgstrategic.orgstrategicID">
        <thead>
          <tr class="grey lighten-2">
            ...
            <th width="20%" class="pa-2 font16 fontBold" style="border: solid 1px black; padding: 3px">ผู้เสนอโครงการ</th>
        ...
        <tbody>
          <tr v-for="project in orgstrategic.projects" :key="project.projectID">
            ...
            <td class="text-right text-on-wrap font16" style="border: solid 1px black; padding: 3px">{{ moneyFormat(project.disburseMoney) }}</td>
