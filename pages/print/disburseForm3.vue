    ...
    <div class="printPage3x2">
      <v-row no-gutters class="mb-2">
        ...
        <v-col cols="12" class="pt-3 font16 thaiJustifiedText">
          &emsp;&emsp;&emsp;ด้วย งานพัสดุ ฝ่ายบริหารทรัพยากร
          วิทยาลัยเทคนิคแพร่มีความประสงค์จะจัด{{ disburse.disburseSubtype
        ...
        <v-col cols="12" class="pt-1 font16 thaiJustifiedText">
          &emsp;&emsp;&emsp;1. เหตุผลความจำเป็นที่ต้อง<span
            class="font16"
            v-if="disburse.expenseName == 'ค่าใช้สอย'"
            >จ้าง</span
          ><span class="font16" v-else>ซื้อ</span> เพื่อ{{
            disburse.disburseDes
          }}
        </v-col>
        <v-col
          cols="12"
          class="font16 thaiJustifiedText"
          v-if="disburse.disburseType"
        >
          &emsp;&emsp;&emsp;2. รายละเอียดของพัสดุ
          <!-- <div class="font16"  v-for="disburselist, index in disburselists" :key="disburselist.key">
          ...
          &emsp;&emsp;&emsp;&emsp;(ตามรายละเอียดแนบท้าย จำนวน
          {{ disburselists.length }} รายการ)
        </v-col>
        <v-col cols="12" class="font16 thaiJustifiedText">
          &emsp;&emsp;&emsp;3. ราคากลางของพัสดุที่จะ<span
            class="font16"
            v-if="disburse.expenseName == 'ค่าใช้สอย'"
            >จ้าง</span
          ><span class="font16" v-else>ซื้อ</span> จำนวน
          {{ moneyFormat(disburse.disburseMoney) }} บาท
        </v-col>
        <v-col cols="12" class="font16 thaiJustifiedText">
          &emsp;&emsp;&emsp;4. วงเงินที่จะ<span
            class="font16"
            v-if="disburse.expenseName == 'ค่าใช้สอย'"
            >จ้าง</span
          ><span class="font16" v-else>ซื้อ</span><br />
          &emsp;&emsp;&emsp;&emsp;{{ disburse.budgettypeName }}
          {{
            disburse.budgettypeName != disburse.budgetplanDes
              ? disburse.budgetplanDes
              : ""
          }}
          พ.ศ.{{ parseInt(disburse.disburseYear) + 543 }} จำนวน
          {{ moneyFormat(disburse.disburseMoney) }} บาท
        </v-col>
        <v-col cols="12" class="font16 thaiJustifiedText">
          &emsp;&emsp;&emsp;5. กำหนดเวลาที่ต้องการใช้พัสดุนั้น
          หรือให้งานนั้นแล้วเสร็จ<br />
          &emsp;&emsp;&emsp;&emsp;กำหนดเวลาการส่งมอบพัสดุ
          หรืองานให้แล้วเสร็จภายใน {{ disburse.orderSendDay }} วัน
          นับถัดจากวันลงนามในสัญญา
        </v-col>
        <v-col cols="12" class="font16 thaiJustifiedText">
          &emsp;&emsp;&emsp;6. วิธีที่จะ<span
            class="font16"
            v-if="disburse.expenseName == 'ค่าใช้สอย'"
            >จ้าง</span
          ><span class="font16" v-else>ซื้อ</span> และเหตุผลที่ต้อง<span
            class="font16"
            v-if="disburse.expenseName == 'ค่าใช้สอย'"
            >จ้าง</span
          ><span class="font16" v-else>ซื้อ</span><br />
          &emsp;&emsp;&emsp;&emsp;ดำเนินการด้วยวิธีเฉพาะเจาะจง
          เนื่องจากการจัดซื้อจัดจ้างพัสดุที่มีการผลิต จำหน่าย ก่อสร้าง
          หรือให้บริการทั่วไป
          และมีวงเงินในการจัดซื้อจัดจ้างครั้งหนึ่งไม่เกินวงเงินตามที่กำหนดในกฎกระทรวง
        </v-col>
        <v-col cols="12" class="font16 thaiJustifiedText">
          &emsp;&emsp;&emsp;7. หลักเกณฑ์การพิจารณาคัดเลือกข้อเสนอ<br />
          &emsp;&emsp;&emsp;&emsp;การพิจารณาคัดเลือกข้อเสนอโดยใช้เกณฑ์ราคา
        </v-col>
        <v-col cols="12" class="font16 thaiJustifiedText">
          &emsp;&emsp;&emsp;8. การขออนุมัติแต่งตั้งคณะกรรมการต่าง ๆ<br />
          &emsp;&emsp;&emsp;&emsp;การแต่งตั้งคณะกรรมการตรวจรับพัสดุโดยวิธีเฉพาะเจาะจง
        </v-col>
        <v-col cols="12" class="pt-3 font16 thaiJustifiedText">
          &emsp;&emsp;&emsp;จึงเรียนมาเพื่อโปรดพิจารณา หากเห็นชอบขอได้โปรด<br />
          &emsp;&emsp;&emsp;&emsp;1. อนุมัติให้ดำเนินการ
          ตามรายละเอียดในรายงานขอ<span
            class="font16"
            v-if="disburse.expenseName == 'ค่าใช้สอย'"
            >จ้าง</span
          ><span class="font16" v-else>ซื้อ</span>ดังกล่าวข้างต้น <br />
          &emsp;&emsp;&emsp;&emsp;2.
          ลงนามในคำสั่งแต่งตั้งคณะกรรมการตรวจรับพัสดุโดยวิธีเฉพาะเจาะจง
        </v-col>
